...
public:
    ...
    explicit SortedPQ(COMP_FUNCTOR comp = COMP_FUNCTOR()) : BaseClass{comp}
    {
        ...
        // essentially done, I think. vector uses less by default
    } // SortedPQ
    ...
    {
        // line in the constructor populates it but not in order.
        // put in order
        updatePriorities();
    ...
    {
        // need to double check this one, might not insert in the right place, could possibly be just low
        // instead of low - begin
    ...
    virtual void pop()
    {
        // get rid of the element at the end(is the extreme according to the note at the top)
        data.pop_back();
    } // pop()
    ...
    virtual const TYPE &top() const
    {
        ...
        /// should just be this since the vector is sorted, last is extreme(note at top)
    ...
    {
        // literally just use sort from the STL
