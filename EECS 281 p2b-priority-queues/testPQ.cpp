...
void testPrimitiveOperations()
{
    ...
    PQ<int> pq2{vec.cbegin(), vec.cend()};
    Eecs281PQ<int> &eecsPQTeset = pq2;

    assert(eecsPQTeset.size() == 7);
    assert(eecsPQTeset.top() == 9);

    eecsPQTeset.pop();
    assert(eecsPQTeset.size() == 6);
    assert(eecsPQTeset.top() == 7);
...
void testHiddenData()
{
    ...
    // PQ<HiddenDataComp> pq{};
    // Eecs281PQ<HiddenDataComp> &eecsPQ = pq;
    // HiddenDataComp h = (3);
    // HiddenDataComp i = (4);
    // eecsPQ.push(h);
    // eecsPQ.push(i);
    ...
    // // populating with an iterator
    // const std::vector<HiddenDataComp> vec{
    //     1,
    //     2,
    //     3,
    //     5,
    ...
    // std::cout << "Calling constructors" << std::endl;
    // // Range-based constructor
    // PQ<HiddenDataComp> pq2{vec.cbegin(), vec.cend()};
    // Eecs281PQ<HiddenDataComp> &eecsPQTeset = pq2;
